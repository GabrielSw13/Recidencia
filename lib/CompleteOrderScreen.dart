...
import 'package:apptienda/comprasf.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'OrdenesPendiente.dart';

class finOrdersScreen extends StatelessWidget {
  const finOrdersScreen({super.key});

  Future<List<Map<String, dynamic>>> _fetchfinOrders() async {
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => fineOrdenScreen(orderId: order['orderId']),
                      ),
                    );
                  },
                ),
